...
export type GetCurrentMarketPrices_currentMarketPrices =
  | GetCurrentMarketPrices_currentMarketPrices_NotFound
  | GetCurrentMarketPrices_currentMarketPrices_CurrentMarketPrices;
