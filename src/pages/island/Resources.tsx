    ...
    <Fragment>
      ...
      <Style>
        ...
        <StatStyle>
          ...
          <div>{FormatNumber(inventory.material)}</div>
        </StatStyle>
        <StatStyle>
          <div>
        ...
        <StatStyle>
          ...
          <div>{FormatNumber(inventory.food)}</div>
        </StatStyle>
        <StatStyle>
          <div>
        ...
        <StatStyle>
          ...
          <div>{FormatNumber(inventory.frozenFood)}</div>
        </StatStyle>
        <StatStyle>
          <div>
          ...
          <div>{FormatNumber(inventory.frozenFoodStorage)}</div>
        </StatStyle>
      </Style>
